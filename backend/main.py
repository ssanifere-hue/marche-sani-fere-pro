...
async def creer_produit(produit: ProduitCreate, current_user = Depends(get_current_user)):
    ...
    vendeur = await db.vendeurs.find_one({"user_id": str(current_user["_id"])}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")})
    if not vendeur:
...
async def commandes_vendeur(current_user=Depends(get_current_user)):
    vendeur = await db.vendeurs.find_one({"user_id": str(current_user["_id"])}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")}) or await db.vendeurs.find_one({"telephone": current_user.get("telephone", "")})
    if not vendeur:
        raise HTTPException(status_code=404, detail="Profil vendeur non trouvé")
    """
